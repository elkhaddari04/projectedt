...
<div class="wrapper" id="app">
 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Comment ca marche </a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
            ...
            <router-link to="/profile" class="nav-link">{{Auth::user()->name}}</router-link>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
      <img src="./img/AdminLTELogo.png" alt="Absense Logo" class="brand-image "
           style="opacity: .8">
      <span class="brand-text ">ABSENSE APP</span>
    </a>
